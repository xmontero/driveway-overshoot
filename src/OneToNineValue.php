 ...
 * Useful for representing the possible values for a Tile, the id of a row, of a column, of a square, the position of a Tile inside a row, of a column, or inside a square, etc.
 */
